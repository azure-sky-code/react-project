const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/react-ljEy_3oQ.js","assets/index-uecx1bNX.js","assets/index-DNfQEzht.css"])))=>i.map(i=>d[i]);
import{r as c,j as r,_ as w}from"./index-uecx1bNX.js";function h(i){const d=()=>typeof window<"u"&&"matchMedia"in window?window.matchMedia(i).matches:!1,[s,m]=c.useState(d);return c.useEffect(()=>{if(typeof window>"u"||!("matchMedia"in window))return;const t=window.matchMedia(i),n=o=>m(o?.matches??t.matches);if(n(),typeof t.addEventListener=="function")return t.addEventListener("change",n),()=>t.removeEventListener("change",n);if(typeof t.addListener=="function")return t.addListener(n),()=>t.removeListener(n)},[i]),s}const g=c.lazy(()=>w(()=>import("./react-ljEy_3oQ.js").then(i=>i.r),__vite__mapDeps([0,1,2])));function y(){const i=h("(min-width: 641px)"),d=h("(min-width: 769px)"),s=h("(min-width: 1025px)"),m=()=>`
        你好，我是 Wendy，${s?"":"<br>"}
        是名「前端訓練家」！<br><br>
        歡迎來到我的冒險回憶島，<br>
